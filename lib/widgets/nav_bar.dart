  ...
  Widget build(BuildContext context) {
      ...
      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
        ...
        Row(children: const [
          NavBarItemWithIcon(
            ...
            url: 'https://github.com/Rakib00111',
          ),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'facebook',
              icon: ImageAssetConstants.facebook,
              url: 'https://www.facebook.com/rakibkhan218/'),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'linkedIn',
              icon: ImageAssetConstants.linkedIn,
              url: 'https://www.linkedin.com/in/rakibkhan218/'),
          SizedBox(width: 50),
        ])
      ])
    ]);
    List<Widget>? navBarColumn = [
      ...
      NavBarItem(
          text: 'github',
          onTap: () async {
            await launch('https://github.com/Rakib00111');
          }),
      NavBarItem(
          text: 'facebook',
          onTap: () async =>
              await launch('https://www.facebook.com/rakibkhan218/')),
      NavBarItem(
          text: 'linkedIn',
          onTap: () async => await launch(
              'https://www.linkedin.com/in/rakibkhan218/')),
    ];
    return Stack(
      children: [
        ObxValue<RxDouble>(
